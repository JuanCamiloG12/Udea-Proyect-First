            ...
            <div className="container px-2 py-4 mx-auto">
                <div className="md:flex md:items-center md:justify-between">
                    <div className="flex items-center justify-between">
                        <div className="text-xl font-semibold text-gray-700 w-40">
                            {/* <a className="text-2xl font-bold text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300" href= "imagen">Pagina de Ropa</a> */}
                    ...
                    <div className="flex-1 md:flex md:items-center md:justify-between">
                        ...
                        <div className="flex items-center mt-4 md:mt-0">
                            <button onClick={() => logout({ returnTo: window.location.origin })} className="hidden mx-4 text-gray-600 md:block dark:text-gray-200 hover:text-gray-700 dark:hover:text-gray-400 focus:text-gray-700 dark:focus:text-gray-400 focus:outline-none" aria-label="show notifications">
                            ...
                            <button onClick={() => loginWithRedirect()}  className="flex items-center focus:outline-none" aria-label="toggle profile dropdown">
                                <div className="w-8 h-8 overflow-hidden border-2 border-gray-400 rounded-full">
                                    {/* <img src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80" className="object-cover w-full h-full" alt="avatar"> */}
                                    <img src={logotipo} alt="logo" className='object-cover w-full h-full'  />
                                </div>
