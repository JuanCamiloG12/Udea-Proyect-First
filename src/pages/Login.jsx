...
const Login = () => {
    return (
        ...
        <div className='flex flex-col w-full justify-center items-center '>
            <h2 className= 'm-3 text-center text-3xl font-extrabold text-gray-900 '>Inicia sesión</h2>
            <form className ='mt-8 max-w-md'>
            <div >
                <input className = 'appearance-none px-3 py-2 w-full  border border-gray-300 focus:outline-none text-gray-900 rounded-t-md focus:ring-indigo-500  focus:border-indigo-500 focus:z-10 sm:text-sm'
                type='email' placeholder='cds@c.com' required/>
                <input  className = 'appearance-none px-3 py-2 w-full  border border-gray-300 focus:outline-none text-gray-900 rounded-t-md focus:ring-indigo-500  focus:border-indigo-500 focus:z-10 sm:text-sm' 
